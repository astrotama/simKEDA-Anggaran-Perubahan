						...
						while ($dataobyek = db_fetch_object($resultobyek)) {
							...
							if ($result) {
								...
								$rowsrek[] = array (
									...
									$sql = 'select * from {anggperukdetilperubahan'.$str_table.'} where kodeuk=\'%s\' and kodero=\'%s\' order by nourut, iddetil';
									...
									if ($resultdetil) {
										while ($datadetil = db_fetch_object($resultdetil)) {
											...
											$rowsrek[] = array (
																 ...
																 array('data' => $hargasatuanp,  'width' => '60px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:small;font-weight:lighter;font-style: italic;'),
...
function GenReportFormFooter($kodeuk, $tipedok, $revisi) {
	...
	//drupal_set_message('Z '. $str_table);
	...
	if ($tipedok=='dpa') {
		...
		if ($data = db_fetch_object($pres)) {
			$total = $data->total;
			$tw1 = round($data->total/4000,0) * 1000;
		}
		...
		*/
		...
		$rowsfooter[] = array (
							 ...
							 array('data' => $pimpinanjabatan,  'width' => '208px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
							 );
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '675px',  'colspan'=>'5',  'style' => 'border-left: 1px solid black; border-right: 1px solid black; text-align:center'),
							 array('data' => '',  'width' => '208px', 'style' => 'border-right: 1px solid black; text-align:right;'),
							 );
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '675px',  'colspan'=>'5',  'style' => 'border-left: 1px solid black; border-right: 1px solid black; text-align:center'),
							 array('data' => '',  'width' => '208px', 'style' => 'border-right: 1px solid black; text-align:right;'),
		...
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '675px',  'colspan'=>'5',  'style' => 'border-left: 1px solid black; border-right: 1px solid black; text-align:center'),
							 array('data' => $pimpinannama,  'width' => '208px', 'style' => 'border-right: 1px solid black; text-align:center; text-decoration: underline;'),
							 );
		$rowsfooter[] = array (
							 ...
							 array('data' => 'NIP. ' . $pimpinannip,  'width' => '208px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
							 );
	}
	$opttbl = array('cellspacing'=>'1', 'cellpadding'=>'1', 'border' => '0');
	$headerkosong = array();

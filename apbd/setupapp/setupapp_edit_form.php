...
function setupapp_edit_form(){
	...
	$form['formdata']['setda'] = array (
        '#type' => 'fieldset',
        '#title'=> 'Sekretariat Daerah',
        '#collapsible' => FALSE,
        '#collapsed' => FALSE,        
    );
	$form['formdata']['setda']['setdanama']= array(
		'#type'         => 'textfield', 
		'#title'        => 'Setda Nama', 
		//'#description'  => 'program', 
		'#maxlength'    => 255, 
	...
	$form['formdata']['setda']['setdanip']= array(
		'#type'         => 'textfield', 
		'#title'        => 'Setda Nip', 
		//'#description'  => 'program', 
		'#maxlength'    => 255, 
	...
	$form['formdata']['setda']['setdajabatan']= array(
		'#type'         => 'textfield', 
		'#title'        => 'Setda Jabatan', 
		//'#description'  => 'program', 
		'#maxlength'    => 255, 
	...
	$form['formdata']['bud'] = array (
        '#type' => 'fieldset',
        '#title'=> 'Bendahara Umum Daerah',
        '#collapsible' => FALSE,
        '#collapsed' => FALSE,        
    );
	$form['formdata']['bud']['budnama']= array(
		'#type'         => 'textfield', 
		'#title'        => 'Bud Nama', 
		//'#description'  => 'program', 
		'#maxlength'    => 255, 
	...
	$form['formdata']['bud']['budnip']= array(
		'#type'         => 'textfield', 
		'#title'        => 'Bud Nip', 
		//'#description'  => 'program', 
		'#maxlength'    => 255, 
	...
	$form['formdata']['bud']['budjabatan']= array(
		'#type'         => 'textfield', 
		'#title'        => 'Bud Jabatan', 
		//'#description'  => 'program', 
		'#maxlength'    => 255, 
    ...
    if ($e_tahun=='') 
    {
		...
		if ($e_revisi==0) 
			$res = db_query(db_rewrite_sql('update {setupapp} set tahun=%s, revisi=%s, uraian=\'%s\',tglbatasrka=\'%s\', 
					tglbatasdpa=\'%s\', tglbatasrevisi=\'%s\', perdano=\'%s\', setdanip=\'%s\', setdanama=\'%s\', setdajabatan=\'%s\', budnip=\'%s\', budnama=\'%s\', budjabatan=\'%s\', perdatgl=\'%s\', perbupno=\'%s\', perbuptgl=\'%s\', perdanop=\'%s\', perdatglp=\'%s\', perbupnop=\'%s\', perbuptglp=\'%s\', dpatgl=\'%s\', dpabtlformat=\'%s\', dpablformat=\'%s\', dpapenformat=\'%s\', dpappkdpformat=\'%s\', dpappkdbformat=\'%s\' where tahun=\'%s\''), array($tahun, $revisi, $uraian, $tglbatasrkasql, $tglbatasdpasql, $tglbatasrevisisql, $perdano, $setdanip, $setdanama, $setdajabatan, $budnip, $budnama, $budjabatan, $perdatgl, $perbupno, $perbuptgl,$perdanop, $perdatglp, $perbupnop, $perbuptglp, $dpatgl, $dpabtlformat, $dpablformat,$dpapenformat, $dpappkdpformat, $dpappkdbformat, $e_tahun));
        
		else if ($e_revisi==1) 
			$res = db_query(db_rewrite_sql('update {setupapp} set tahun=%s, revisi=%s, uraian=\'%s\',tglbatasrka=\'%s\', 
					tglbatasdpa=\'%s\', tglbatasrevisi=\'%s\', perdano=\'%s\', setdanip=\'%s\', setdanama=\'%s\', setdajabatan=\'%s\', budnip=\'%s\', budnama=\'%s\', budjabatan=\'%s\', perdatgl=\'%s\', perbupno=\'%s\', perbuptgl=\'%s\', perdanop=\'%s\', perdatglp=\'%s\', perbupnop=\'%s\', perbuptglp=\'%s\', dpatgl=\'%s\', dpabtlformat=\'%s\', dpablformat=\'%s\', dpapenformat=\'%s\', dpappkdpformat=\'%s\', dpappkdbformat=\'%s\', dpatgl1=\'%s\', dpabtlformat1=\'%s\', dpablformat1=\'%s\', dpapenformat1=\'%s\', dpappkdpformat1=\'%s\', dpappkdbformat1=\'%s\' where tahun=\'%s\''), array($tahun, $revisi, $uraian, $tglbatasrkasql, $tglbatasdpasql, 		
					$tglbatasrevisisql, $perdano, $setdanip, $setdanama, $setdajabatan, $budnip, $budnama, $budjabatan, $perdatgl, $perbupno, $perbuptgl,$perdanop, $perdatglp, $perbupnop, $perbuptglp, $dpatgl, $dpabtlformat, $dpablformat,$dpapenformat, $dpappkdpformat, $dpappkdbformat, $dpatgl1, $dpabtlformat1, $dpablformat1,$dpapenformat1, $dpappkdpformat1, $dpappkdbformat1, $e_tahun));

		else if ($e_revisi==2) 
			$res = db_query(db_rewrite_sql('update {setupapp} set tahun=%s, revisi=%s, uraian=\'%s\',tglbatasrka=\'%s\', 
					tglbatasdpa=\'%s\', tglbatasrevisi=\'%s\', perdano=\'%s\', setdanip=\'%s\', setdanama=\'%s\', setdajabatan=\'%s\', budnip=\'%s\', budnama=\'%s\', budjabatan=\'%s\', perdatgl=\'%s\', perbupno=\'%s\', perbuptgl=\'%s\', perdanop=\'%s\', perdatglp=\'%s\', perbupnop=\'%s\', perbuptglp=\'%s\', dpatgl=\'%s\', dpabtlformat=\'%s\', dpablformat=\'%s\', dpapenformat=\'%s\', dpappkdpformat=\'%s\', dpappkdbformat=\'%s\', 
					...
					$tglbatasrevisisql, $perdano, $setdanip, $setdanama, $setdajabatan, $budnip, $budnama, $budjabatan, $perdatgl, $perbupno, $perbuptgl,$perdanop, $perdatglp, $perbupnop, $perbuptglp, $dpatgl, $dpabtlformat, $dpablformat,$dpapenformat, $dpappkdpformat, $dpappkdbformat, 
					$dpatgl1, $dpabtlformat1, $dpablformat1,$dpapenformat1, $dpappkdpformat1, $dpappkdbformat1, 
					$dpatgl2, $dpabtlformat2, $dpablformat2,$dpapenformat2, $dpappkdpformat2, $dpappkdbformat2, 
					$e_tahun));

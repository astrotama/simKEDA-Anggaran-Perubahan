<?php
function lampiran4_preview_main() {
...
function lampiran4_form_submit($form, &$form_state) {
	...
	if($form_state['clicked_button']['#value'] == $form_state['values']['tampilkan']) 
		$uri = 'apbd/laporan/apbd/lampiran4preview/' .$revisi.'/' . $topmargin . '/' . $hal1 ;
	else
		$uri = 'apbd/laporan/apbd/lampiran4preview/'.$revisi.'/' . $topmargin . '/' . $hal1 . '/pdf' ;
	drupal_goto($uri);

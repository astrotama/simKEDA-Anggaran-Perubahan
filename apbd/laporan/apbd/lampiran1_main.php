...
drupal_add_css('files/css/kegiatancam.css');
	...
	*/
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		$htmlContent = GenReportFormContentPrint($kodeuk, $tingkat, $revisi);
				...
				while ($datakel = db_fetch_object($resultkel)) {
					...
					if ($result) {
						while ($data = db_fetch_object($result)) {
							...
							$uraianj = l($uraianj, 'apbd/laporan/apbd/lampiran1detil/pendapatan_jenis_uk/' . $data->kodej, array('html'=>TRUE));
							...
							if ($tingkat>=4) {
								...
								if ($resulto) {
									while ($datao = db_fetch_object($resulto)) {
										...
										$uraiano = l($datao->uraian, 'apbd/laporan/apbd/lampiran1detil/pendapatan_obyek_uk/' . $datao->kodeo, array('html'=>TRUE));
										...
										if ($tingkat>=5) {
											...
											if ($resultro) {
												while ($dataro = db_fetch_object($resultro)) {
													...
													$uraian = l($dataro->uraian, 'apbd/laporan/apbd/lampiran1detil/pendapatan_rincian_uk/' . $dataro->kodero, array('html'=>TRUE));
				...
				while ($datakel = db_fetch_object($resultkel)) {
					...
					if ($result) {
						while ($data = db_fetch_object($result)) {
							...
							$uraianj = l($uraianj, 'apbd/laporan/apbd/lampiran1detil/belanja_jenis_uk/' . $data->kodej, array('html'=>TRUE));
							...
							if ($tingkat>=4) {
								...
								if ($resulto) {
									while ($datao = db_fetch_object($resulto)) {
										...
										$uraiano = l($datao->uraian, 'apbd/laporan/apbd/lampiran1detil/belanja_obyek_uk/' . $datao->kodeo, array('html'=>TRUE));
										...
										if ($tingkat>=5) {
											...
											if ($resultro) {
												while ($dataro = db_fetch_object($resultro)) {
													...
													$uraian_ro = l($dataro->uraian, 'apbd/laporan/apbd/lampiran1detil/belanja_rincian_uk/' . $dataro->kodero, array('html'=>TRUE));
...
function GenReportFormContentPrint($kodeuk, $tingkat, $revisi) {
	//drupal_set_message($revisi);

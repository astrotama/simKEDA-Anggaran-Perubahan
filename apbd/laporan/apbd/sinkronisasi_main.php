...
function GenReportFormContent($prov) {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'No',  'width'=> '35px','rowspan'=>'2', 'style' => 'border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Prioritas Pembangunan ' . $strbidang,  'width' => '165px','colspan'=>'2','rowspan'=>'2', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Uraian', 'width' => '405px', 'colspan'=>'4','style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Alokasi Anggaran Belanja dalam Rancangan Perubahan APBD',  'width' => '270px', 'colspan'=>'3', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'Belanja Tidak Langsung',  'width' => '125px','colspan'=>'2',  'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
			...
			*/
			...
			if (($bidnumbl+$bidnumbtl)>0) {
				$rowsrek[] = array (
									 ...
									 array('data' => '',  'width' => '145px', 'style ' => ' border-right: 1px solid black; text-align:left;font-size:50%;'),
									 array('data' => '',  'width' => '280px','colspan'=>'2', 'style' => ' border-right: 1px solid black; text-align:right;font-size:50%;'),
									 array('data' => '',  'width' => '125px', 'colspan'=>'2','style' => ' border-right: 1px solid black; text-align:right;font-size:50%;'),
				...
				$rowsrek[] = array (
									 array('data' => $nomor . '.',  'width'=> '35px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
									 array('data' => strtoupper($databid->uraian),  'width' => '165px','colspan'=>'2', 'style ' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
									 ...
									 array('data' => '',  'width' => '125px', 'colspan'=>'2', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
									 array('data' => apbd_fn($bidnumbl),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
									 array('data' => apbd_fn($bidnumbtl),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
									 array('data' => apbd_fn($bidnumbl + $bidnumbtl),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
									 );		
				...
				if ($resultu) {
					while ($datau = db_fetch_object($resultu)) {
						...
						$sql = 'select k.jenis,sum(k.total' . $kolom_anggaran . ') totalu from prioritasprogram' . $prov . ' pp inner join ' . $tabel_kegiatan . ' k on pp.kodepro=k.kodepro inner join program p on k.kodepro=p.kodepro ' . $where . ' group by k.jenis';
						//drupal_set_message($sql);
						$resunom = db_query($sql);								
						...
						$rowsrek[] = array (
											 ...
											 array('data' => '',  'width' => '145px', 'style ' => ' border-right: 1px solid black; text-align:left;font-size:30%;'),
											 array('data' => '',  'width' => '280px','colspan'=>'2', 'style' => ' border-right: 1px solid black; text-align:right;font-size:30%;'),
											 array('data' => '',  'width' => '125px', 'colspan'=>'2', 'style' => ' border-right: 1px solid black; text-align:right;font-size:30%;'),
											 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:30%;'),
											 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;font-size:30%;'),
											 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;font-size:30%;'),
										);			
						$rowsrek[] = array (
											 ...
											 array('data' => strtoupper($datau->urusan),  'width' => '145px', 'style ' => ' border-right: 1px solid black; text-align:left;'),
											 array('data' => '',  'width' => '280px','colspan'=>'2', 'style' => ' border-right: 1px solid black; text-align:right;'),
											 array('data' => '',  'width' => '125px','colspan'=>'2',  'style' => ' border-right: 1px solid black; text-align:right;'),
											 array('data' => apbd_fn($unumbl),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
											 array('data' => apbd_fn($unumbtl),  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;font-weight:bold;'),
											 array('data' => apbd_fn($unumbl+$unumbtl),  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;font-weight:bold;'),
										);		
						
						$where = sprintf(' and k.inaktif=0 and pp.prioritasno=\'%s\'', db_escape_string($databid->prioritasno));
						...
						if ($resbtl) { 
							while ($databtl = db_fetch_object($resbtl)) {
								...
								$rowsrek[] = array (
													 array('data' => '',  'width'=> '35px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
													 array('data' => '',  'width' => '165px','colspan'=>'2', 'style ' => ' border-right: 1px solid black; text-align:left;'),
													 array('data' => '',  'width' => '10px', 'style' => ' text-align:center;'),
													 array('data' => $bluraian,  'width' => '270px', 'style' => ' border-right: 1px solid black; text-align:left;'),
													 array('data' => '-',  'width' => '10px','style' => ' text-align:center;'), 
													 array('data' => ucfirst(strtolower($databtl->uraian)),  'width' => '115px', 'style' => ' border-right: 1px solid black; text-align:left;'),
													 array('data' => apbd_fn($blnom),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;'),
													 array('data' => apbd_fn($databtl->totalbtl),  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;'),
													 array('data' => apbd_fn($blnom+$databtl->totalbtl),  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;'),
													 );									
						...
						if ($resbl) {
							while ($databl = db_fetch_object($resbl)) {
								...
								$rowsrek[] = array (
													 ...
													 array('data' => '',  'width' => '165px','colspan'=>'2', 'style ' => ' border-right: 1px solid black; text-align:left;'),
													 array('data' => '-',  'width' => '10px', 'style' => ' text-align:center;'),
													 array('data' => $databl->program,  'width' => '270px', 'style' => ' border-right: 1px solid black; text-align:left;'),
													 array('data' => $btluraian,  'width' => '125px', 'colspan'=>'2','style' => ' border-right: 1px solid black; text-align:left;'),
													 array('data' => apbd_fn($databl->totalbl),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;'),
													 array('data' => apbd_fn($btlnom),  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;'),
													 array('data' => apbd_fn($databl->totalbl+$btlnom),  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;'),
													 );								
	...
	$rowsrek[] = array (
						 array('data' => 'TOTAL',  'width'=> '605px',  'colspan'=>'7',  'style' => 'border-left: 1px solid black; border-bottom: 2px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center; font-weight:bold;'),
...
function GenReportFormContentAsli($prov) {
		...
		while ($databid = db_fetch_object($resultbid)) {
			...
			if (($bidnumbl+$bidnumbtl)>0) {
				$rowsrek[] = array (
									 array('data' => '',  'width'=> '35px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:50%;'),
									 array('data' => '',  'width' => '20px', 'style ' => ' text-align:center;font-size:50%;'),
									 array('data' => '',  'width' => '180px', 'style ' => ' border-right: 1px solid black; text-align:left;font-size:50%;'),
									 array('data' => '',  'width' => '280px','colspan'=>'2', 'style' => ' border-right: 1px solid black; text-align:right;font-size:50%;'),
									 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:50%;'),
									 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:50%;'),
									 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;font-size:50%;'),
				...
				if ($resultu) {
					while ($datau = db_fetch_object($resultu)) {
						...
						$rowsrek[] = array (
											 array('data' => '',  'width'=> '35px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:30%;'),
											 array('data' => '',  'width' => '20px', 'style ' => ' text-align:center;font-size:30%;'),
											 array('data' => '',  'width' => '180px', 'style ' => ' border-right: 1px solid black; text-align:left;font-size:30%;'),
											 array('data' => '',  'width' => '280px','colspan'=>'2', 'style' => ' border-right: 1px solid black; text-align:right;font-size:30%;'),
											 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:30%;'),
											 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:30%;'),
											 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;font-size:30%;'),
						...
						$rowsrek[] = array (
											 array('data' => '',  'width'=> '35px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
											 array('data' => chr($pbul) . '.',  'width' => '20px', 'style ' => ' text-align:center;'),
											 array('data' => strtoupper($datau->uraian),  'width' => '180px', 'style ' => ' border-right: 1px solid black; text-align:left;'),
											 array('data' => '',  'width' => '280px','colspan'=>'2', 'style' => ' border-right: 1px solid black; text-align:right;'),
											 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;'),
											 array('data' => apbd_fn($unumbl),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
											 array('data' => apbd_fn($unumbtl),  'width' => '90px', 'style' => ' border-right: 1px solid black;  text-align:right;font-weight:bold;'),

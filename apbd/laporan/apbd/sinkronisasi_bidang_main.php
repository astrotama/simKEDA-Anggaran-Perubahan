...
function GenReportFormContent($prov) {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'No',  'width'=> '35px','rowspan'=>'2', 'style' => 'border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Bidang Pembangunan ' . $strbidang,  'width' => '165px','colspan'=>'2','rowspan'=>'2', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	if ($resultbid) 	{
		while ($databid = db_fetch_object($resultbid)) {
			...
			if (($bidnumbl+$bidnumbtl)>0) {
				...
				$rowsrek[] = array (
									 array('data' => $nomor . '.',  'width'=> '35px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
									 array('data' => $databid->namabid,  'width' => '165px','colspan'=>'2', 'style ' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
				...
				if ($resultu) {
					while ($datau = db_fetch_object($resultu)) {
						...
						$rowsrek[] = array (
											 ...
											 array('data' => strtoupper($datau->uraian),  'width' => '145px', 'style ' => ' border-right: 1px solid black; text-align:left;'),

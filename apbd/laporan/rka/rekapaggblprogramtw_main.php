...
function GenReportFormPerubahanContent($kodeuk, $tipedok,$revisi) {
	...
	/*
	$headersrek[] = array (
							 array('data' => 'Kode', 'width' => '40px','rowspan'=>'2', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Uraian Program Kegiatan', 'width' => '175px','rowspan'=>'2', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Lokasi Kegiatan', 'width' => '90px','rowspan'=>'2', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Target Kinerja(Kuantitatif)', 'width' => '90px','rowspan'=>'2', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Sumber dana', 'width' => '90px','rowspan'=>'2', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
	...
	*/
	$headersrek[] = array (
							 array('data' => 'Kode', 'width' => '40px','rowspan'=>'2', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Uraian', 'width' => '225px', 'style' => 'border-top:1px solid black;border-left:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Lokasi', 'width' => '90px', 'style' => 'border-top:1px solid black;border-left:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Target Kinerja', 'width' => '90px', 'style' => 'border-top:1px solid black;border-left:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Sumberdana', 'width' => '90px','rowspan'=>'2', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Jumlah (Rp)', 'width' => '200px', 'colspan'=>'2', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Bertambah/Berkurang', 'width' => '142px', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
						 );	
	
	$headersrek[] = array (
							array('data' => 'Program Kegiatan', 'width' => '225px', 'style' => 'border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							array('data' => 'Kegiatan', 'width' => '90px', 'style' => 'border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							array('data' => '(Kuantitatif)', 'width' => '90px', 'style' => 'border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							array('data' => 'Sebelum Perubahan', 'width' => '100px', 'style' => 'border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							array('data' => 'Setelah Perubahan', 'width' => '100px', 'style' => 'border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),	
							array('data' => '(Rp)', 'width' => '95px', 'style' => 'border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							array('data' => '%', 'width' => '46px', 'style' => 'border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
						 );	
	//PROGRAM
	$total = 0;$totalp = 0;
	$t_tw1 =0;
	...
	if ($resultpro) {
		while ($datapro = db_fetch_object($resultpro)) {
			...
			$rowsrek[] = array (
									 array('data' => $datapro->kodepro, 'width' => '40px', 'style' => 'border-left:1px solid black;text-align:left;font-size: 100%;'),
									 array('data' => $datapro->program, 'width' => '225px', 'style' => 'border-left:1px solid black;text-align:left;font-weight:bold;font-size: 100%;'),
									 array('data' => '', 'width' => '90px', 'style' => 'border-left:1px solid black;text-align:left;font-weight:bold;font-size: 100%;'),
									 array('data' => '', 'width' => '90px', 'style' => 'border-left:1px solid black;text-align:left;font-weight:bold;font-size: 100%;'),
									 array('data' => '', 'width' => '90px', 'style' => 'border-left:1px solid black;text-align:left;font-weight:bold;font-size: 100%;'),
									 array('data' => apbd_fn($datapro->jumlahx), 'width' => '100px', 'style' => 'border-left:1px solid black;text-align:right;font-weight:bold;font-size: 100%;'),
									 array('data' => apbd_fn($datapro->jumlahxp), 'width' => '100px', 'style' => 'border-left:1px solid black;text-align:right;font-weight:bold;font-size: 100%;'),	
									 array('data' => apbd_fn($datapro->jumlahxp-$datapro->jumlahx), 'width' => '95px', 'style' => 'border-left:1px solid black;text-align:right;font-weight:bold;font-size: 100%;'),
									 array('data' => apbd_fn2(apbd_hitungpersen($datapro->jumlahx,$datapro->jumlahxp)), 'width' => '46px', 'style' => 'border-left:1px solid black;border-right:1px solid black;text-align:right;font-weight:bold;font-size: 100%;'),
			...
			if ($resultkeg) { 
				while ($datakeg = db_fetch_object($resultkeg)) {
					...
					$rowsrek[] = array (
											array('data' => $datapro->kodepro . '.' . substr($datakeg->kodekeg, -3), 'width' => '40px', 'style' => 'border-left:1px solid black;text-align:left;font-size: 100%;'),
											 array('data' => $datakeg->kegiatan, 'width' => '225px', 'style' => 'border-left:1px solid black;text-align:left;font-size: 100%;'),
											 array('data' => str_replace('||',', ', $datakeg->lokasi), 'width' => '90px', 'style' => 'border-left:1px solid black;text-align:left;font-size: 100%;'),
											 array('data' => $datakeg->programtarget, 'width' => '90px', 'style' => 'border-left:1px solid black;text-align:left;font-size: 100%;'),
											 array('data' => $sumberdana, 'width' => '90px', 'style' => 'border-left:1px solid black;text-align:left;font-size: 100%;'),
											 array('data' => apbd_fn($datakeg->total), 'width' => '100px', 'style' => 'border-left:1px solid black;text-align:right;font-size: 100%;'),
											 array('data' => apbd_fn($datakeg->totalp), 'width' => '100px', 'style' => 'border-left:1px solid black;text-align:right;font-size: 100%;'),	
											 array('data' => apbd_fn($datakeg->totalp-$datakeg->totalp), 'width' => '95px', 'style' => 'border-left:1px solid black;text-align:right;font-size: 100%;'),
											 array('data' => apbd_fn2(apbd_hitungpersen($datakeg->total,$datakeg->totalp)), 'width' => '46px', 'style' => 'border-left:1px solid black;border-right:1px solid black;text-align:right;font-size: 100%;'),
	...
	$rowsrek[] = array (
							 array('data' => '', 'width' => '40px', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center;font-weight:bold;font-size: 100%;'),
							 array('data' => 'Jumlah', 'width' => '495px', 'colspan'=>'4', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:right;font-weight:bold;font-size: 100%;'),
							 array('data' => apbd_fn($total), 'width' => '100px', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:right;font-weight:bold;font-size: 100%;'),
							 array('data' => apbd_fn($totalp), 'width' => '100px', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:right;font-weight:bold;font-size: 100%;'),
							 array('data' => apbd_fn($totalp-$total), 'width' => '95px', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:right;font-weight:bold;font-size: 100%;'),	
							 array('data' => apbd_fn2(apbd_hitungpersen($total,$totalp)), 'width' => '46px', 'style' => 'border-top:1px solid black;border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black;text-align:right;font-weight:bold;font-size: 100%;'),

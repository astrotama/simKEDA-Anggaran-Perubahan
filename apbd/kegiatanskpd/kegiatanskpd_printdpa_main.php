						...
						$rowsrek[] = array (
							...
							if ($resultdetil) {
								while ($datadetil = db_fetch_object($resultdetil)) {
									...
									if ($datadetil->pengelompokan) {
										//SUB DETIL
										$sql = 'select idsub,uraian,unitjumlah,unitsatuan,volumjumlah, volumsatuan,harga,total from {anggperkegdetilsub} where total>0 and iddetil=\'%s\' order by nourut asc,idsub';
